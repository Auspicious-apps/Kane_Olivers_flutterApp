...
class Strings {
  ...
  static const String expDate = 'Expiry date can\'t be Empty';
  static const String numberIsInvalid = 'Oops ! card number is invaild';
...
class CardUtils {
  ...
  static String? validateDate(String value) {
    ...
    if (!hasDateExpired(month + 1, year)) {
