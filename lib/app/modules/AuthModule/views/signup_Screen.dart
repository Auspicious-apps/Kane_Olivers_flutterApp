...
class SignupScreen extends GetView<SignUpController> {
          ...
          children: [
            TextSpan(
              ...
              style: textStyleBodyLarge().copyWith(
                ...
                decorationStyle:
                    TextDecorationStyle.solid, // Optional: ensures a solid line
                decorationThickness: 1.5, // Adjust thickness for visibility
                decorationColor:
                    Colors.yellow, // Match or customize underline color
                fontSize: 13,
                color: Colors.yellow,
                fontWeight: FontWeight.w900,
                fontFamily: "Mulish",
                height:
                    1.5, // Increases vertical spacing, pushing underline further from text
              ),
            ),
          ],
        ),
  ...
  Widget _nextButton() => Obx(() => MaterialButtonWidget(
        ...
        onPressed: () {
          print(controller.refferalcode.value);
            ...
            if (controller.isloading.value == false) {
              ...
              Map<String, dynamic> requestModel =
                  AuthRequestModel.SignupRequestModel(
                      ...
                      referalCode: controller.refferalcode.value,
                      fcmToken: "");
